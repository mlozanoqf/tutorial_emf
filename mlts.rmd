...
```{r from tbls to tsibble}
beer_tbls <- beer
beer_tbls$date <- yearmonth(beer_tbls$date)
beer_tbls <- as_tsibble(beer_tbls)
```

According to @hyndman2021forecasting, the X-11 method originated in the US Census Bureau and was further developed by Statistics Canada. The process tends to be highly robust to outliers and level shifts in the time series. The details of the X-11 method are described in @dagum2016seasonal.
