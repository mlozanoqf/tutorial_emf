...
future_idx <- tail(beer$date, 9) # The 10-months forecast period.
...
fcast_arima <- forecast(fit_arima, h = 9)
fcast_arima
```
...
m <- data.frame(as.data.frame(pred_h2o),as.data.frame(pred_h2o_DL),
        ...
        as.data.frame(fcast_tbl$sales[(nrow(fcast_tbl)-8):nrow(fcast_tbl)]))
