...
```{r fig.cap="Beer sales: train, validation and test sets."}
beer %>%
...
```{r fig.cap="Zoom. Beer sales: train, validation and test sets."}
beer %>%
...
```{r fig.cap="Forecast. ARIMA(1,1,2)(2,1,1)[12] residual diagnosis."}
sw_augment(fit_arima, timetk_idx = TRUE) %>%
...
```{r fig.cap="Forecast. ARIMA(1,1,2)(2,1,1)[12]."}
fcast_tbl %>%
